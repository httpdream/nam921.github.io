...
$query = "select* from board_howto where idx=$_GET[id]";
$result = mysql_query($query);
$row = mysql_fetch_row($result);

$query = "select* from reply_howto where idx=$_GET[id]";
$result = mysql_query($query);
...
<div class='end'>qwe</div>            
            ...
            <div id='bot'>
            <span id='hid'><a href='modify_howto.php?id=<?=$_GET['id']?>'><input type="button" id="btn" value="수정"></a></span>
                <span id='hid'><a href='delete_howto.php?id=<?=$_GET['id']?>'><input type="button" id="btn" value="삭제"></a></span>
                </div>
        </div>
