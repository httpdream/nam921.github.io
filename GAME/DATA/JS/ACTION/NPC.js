                  ...
                  callback: function(){
                      ...
                      if(this_status==1){ //침대에 눕습니다
                          makeScriptAction(['은비님, 깨셨나요?', '어라, 아직도 잠들어 계신 건가요?', '이상하다. 박사님이 분명 이쯤 깨실 거라고 했는데 ...', '설마 자는 척 하는건 아니시죠? 은비님, 이 세진이를 속이면 다 들통나요~', '평소대로라면 간지럽혀서 일으킬텐데, 지금은 그럴 상황이 아니시니...', '이따가 올게요, 그 때까진 깨어나셨으면 좋겠네요.', '#우리들은 아직 할 말이 많으니까.하하하하하히히힣' ], function(){
                              ...
                              makeScriptAction(['……이게 무슨 상황이지?', '틀림없어, 연구일지의 이름은 아까 그 여자가 부르던 이름이야 ………', '상황을 정리해 보자.', '나는 연구실 침대에 누워있었고, 누군가 나를 관찰한 「연구일지」를 쓰고 있었어.', '거기엔 다 끝났다고 적혀 있었어.', '여자도 내가 깨어나기를 기다리는 것 같고…', '나는 왜 이곳에 있는 걸까?', '어떤 일이 있었던 걸까?', '그, 말로만 듣던 그런 걸까? 무시무시한 비밀 실험의 실험체 같은……', '나가야해.', '여기에 오래있으면 안돼.', '(알수없는 무언가가 나에게 나가야한다고 말하는것 같다. 빨리 나가자)'], function(){Action_Array[0].status=1;});
